...
WIKI_JS_DB_PASS=`openssl rand -base64 16`

APP_DIR=/mnt/ssd/apps/wikijs
LOCAL_DATA_DIR=/mnt/ssd/apps-local/wikijs
...
echo "WIKI_JS_DB_PASS=$WIKI_JS_DB_PASS" >> $APP_DIR/.env
